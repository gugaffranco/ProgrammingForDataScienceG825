...
This project, "Where Should I Live", aims to simplify this decision-making process by analyzing key characteristics of European countries, such as cost of living, safety, and employment. Through exploratory analysis, visualizations, and interpretable insights, your goal is to build a framework that empowers users to evaluate which countries align best with their personal values and life goals.
